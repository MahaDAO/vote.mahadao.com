...
You acknowledge and understand that voting based on smart contracts, blockchains and cryptographic systems in general, including the so-called on-chain voting, is a new and progressing field. Any of the risks mentioned above may result in the theft or loss of your cryptographic tokens (including MAHA tokens) or property and also in various inaccuraccies regarding votes you aimed to cast, including your vote not being casted at all or casted in an unintended way. For more information about some of the dangers and pitfalls associated with blockchain based voting systems please refer to the following http://hackingdistributed.com/2018/07/02/on-chain-vote-buying/
#### 5. Indemnity
